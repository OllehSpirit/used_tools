...
function MainNavigation() {
  ...
  return (
    <div className={classes.mainNav}>
      ...
      <a href="#home" className={classes.nav}>
        H O M E
      </a>
      <a href="#features" className={classes.nav}>
        S T O R E S
      </a>
      <a href="#products" className={classes.nav}>
        C A T E G O R I E S
      </a>
      <a href="#products" className={classes.nav}>
        L A T E S T<span className={classes.num}>+20</span>
      </a>
