...
function Categories(){
    ...
    return(
        <div>
            ...
            <AutoTyping/>
            <button onClick={translateCardsRight2} id='trans2' className={classes.btnRight}><i className="bx bx-chevron-right"></i></button>
            <button onClick={translateCardsLeft2} id='transLeft2' className={classes.btnLeft}><i className="bx bx-chevron-left"></i></button>

            <h2 className={classes.h2} id='title'> S t o r e s &nbsp; N e a r &nbsp; Y o u</h2>
            ...
            <h2 className={classes.h2} id='title'> B e l o v e d &nbsp;&nbsp; P r o d u c t s </h2>
            <a href="SeeAllStores" className={classes.a}>SEE ALL {'>>'}</a>
